...
\author{ TODO!!! \\
Walter Daelemans* \and Jakub Zavrel*$\dagger$ \and Ko van der Sloot \and
	Antal van den Bosch\\ \ \\
...
\title{{\huge TiMBLServer: Tilburg Memory-Based Learner} \\ \vspace*{0.5cm}
{\bf version 1.0} \\ \vspace*{0.5cm}{\huge Server Manual}\\
\vspace*{1cm} {\it ILK Technical Report -- ILK TOTO}}
...
This Manual describes the Server Interface of TiMBL. To be able to use TimblServer you need a working installation of Timbl (version 6.3 or upward)
For information on the installation and use of Timbl see TODO

This is the first release of the separate TimblServer package, which includes some new functionality compared to TiMBL 6.2.
Although this release has been tested for
