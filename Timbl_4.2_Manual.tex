...
\author{Walter Daelemans* \and Jakub Zavrel*$\dagger$ \and Ko van der Sloot \and
	...
	http://ilk.kub.nl/downloads/pub/papers/ilk0201.ps.gz. All rights reserved
...
{\bf version 4.2} \\ \vspace*{0.5cm}{\huge Reference Guide}\\
\vspace*{1cm} {\it ILK Technical Report -- ILK 02-01}}
...
The current release (version 4.2) adds a number of new features to
those available in the previous major release (3.0). Visible and
...
A more elaborate description of the changes from version 1.0 up to 4.2
...
Based Learner, version 4.2, Reference Guide. ILK Technical Report
02-01, Available from {\tt
http://ilk.kub.nl/downloads/pub/papers/ilk0201.ps.gz}}
...
proceed to download the file {\tt Timbl.4.2.tar.gz}. This file contains
...
{\tt > gunzip Timbl.4.2.tar.gz}

and unpack the tar archive:

{\tt > tar -xvf Timbl.4.2.tar}
...
released versions (1.0 up to 4.2) for users already familiar with the
program.

\section{From version 3.0 to 4.2}

Version 4.2 is an intermediate upgrade of version 4.1. Minor changes from
4.0 to 4.1 to 4.2 are found at the bottom of this list
...
TiMBL (which has changed considerably from version 3.0 to 4.2), will
be available upon request (to {\tt Timbl@kub.nl}) from version 4.2
onwards.
...
\item {\bf [Change from 4.1 to 4.2]} Feature value and class
information in the internal TiMBL tree is hashed, by default. Hashing
has been made optional through the flag {\tt +H} or {\tt -H}, and set
on by default.

\item {\bf [Change from 4.0 to 4.2]} The discretization of numeric
...
\item {\bf [Change from 4.1 to 4.2]} Tie resolution between equal
...
Start:          0 @ Thu Apr 11 02:34:09 2002
Finished:    2999 @ Thu Apr 11 02:34:10 2002
Calculating Entropy         Thu Apr 11 02:34:10 2002
Lines of data     : 2999
...
Start:          0 @ Thu Apr 11 02:34:10 2002
Finished:    2999 @ Thu Apr 11 02:34:10 2002
...
Tested:      1 @ Thu Apr 11 02:34:10 2002
Tested:      2 @ Thu Apr 11 02:34:10 2002
Tested:      3 @ Thu Apr 11 02:34:10 2002
Tested:      4 @ Thu Apr 11 02:34:10 2002
Tested:      5 @ Thu Apr 11 02:34:10 2002
Tested:      6 @ Thu Apr 11 02:34:10 2002
Tested:      7 @ Thu Apr 11 02:34:10 2002
Tested:      8 @ Thu Apr 11 02:34:10 2002
Tested:      9 @ Thu Apr 11 02:34:10 2002
Tested:     10 @ Thu Apr 11 02:34:10 2002
Tested:    100 @ Thu Apr 11 02:34:10 2002
Ready:     950 @ Thu Apr 11 02:34:11 2002
...
exemplar-weighted distance between instances $X$ and $Y$, and $ew_{X}$ is the exemplar weight of memory instance $X$:
