...
\author{Walter Daelemans* \and Jakub Zavrel*$\dagger$ \and Ko van der Sloot \and
	...
	http://ilk.uvt.nl/downloads/pub/papers/ilk0310.pdf. All rights reserved
...
{\bf version 5.0} \\ \vspace*{0.5cm}{\huge Reference Guide}\\
\vspace*{1cm} {\it ILK Technical Report -- ILK 03-10}}
...
The current release (version 5.0) is a major release based on the
recent releases 4.0 to 4.3, concluding a series of recodings. This
version of TiMBL works with MBT, the memory-based tagger, version 2.0
\cite{Daelemans+03}.  An elaborate description of the changes from
version 1.0 up to 5.0 can be found in Chapter~\ref{changes}. Although
all new features have been tested for some time in our research group,
the software may still contain bugs and inconsistencies in some
places. We would appreciate it if you would send bug reports, ideas
...
van der Sloot, and Antal van den Bosch (2003). TiMBL: Tilburg Memory
Based Learner, version 5.0, Reference Guide. ILK Technical Report
03-10, Available from {\tt
...
proceed to download the file {\tt Timbl.5.0.tar.gz}. This file contains
...
{\tt > gunzip Timbl.5.0.tar.gz}

and unpack the tar archive:

{\tt > tar -xvf Timbl.5.0.tar}
...
released versions (1.0 up to 5.0) for users already familiar with the
program.
...
{\small
\begin{verbatim}
TiMBL 5.0.0 (release) (c) ILK 1998 - 2003.
Tilburg Memory Based Learner
Induction of Linguistic Knowledge Research Group
Tilburg University / University of Antwerp
Mon Sep 15 17:03:49 2003
...
Start:          0 @ Mon Sep 15 17:03:50 2003
Finished:    2999 @ Mon Sep 15 17:03:50 2003
Calculating Entropy         Mon Sep 15 17:03:50 2003
Lines of data     : 2999
...
Start:          0 @ Mon Sep 15 17:05:21 2003
Finished:    2999 @ Mon Sep 15 17:05:21 2003
...
Feature 11       : 0.185070180760328
Feature 12       : 0.325371814230901

Tested:      1 @ Mon Sep 15 17:05:21 2003
Tested:      2 @ Mon Sep 15 17:05:21 2003
Tested:      3 @ Mon Sep 15 17:05:21 2003
Tested:      4 @ Mon Sep 15 17:05:21 2003
Tested:      5 @ Mon Sep 15 17:05:21 2003
Tested:      6 @ Mon Sep 15 17:05:21 2003
Tested:      7 @ Mon Sep 15 17:05:21 2003
Tested:      8 @ Mon Sep 15 17:05:21 2003
Tested:      9 @ Mon Sep 15 17:05:21 2003
Tested:     10 @ Mon Sep 15 17:05:21 2003
Tested:    100 @ Mon Sep 15 17:05:21 2003
Ready:     950 @ Mon Sep 15 17:05:21 2003
...
\hline
{\sc ib1}, $-k1$ & 88.4 & 96.3 & 96.3 & 95.3 & \\
{\sc ib1}, $-k3$ & 73.7 & 96.1 & 96.6 & 96.6 & 96.7 \\
{\sc mvdm}, $-k1$ & 95.6  & 96.3 & 96.3 & 96.3 & \\
{\sc mvdm}, $-k5$ & 97.1 & 97.6 & {\bf 97.5} & {\bf 97.5} & 96.5\\
\hline
\end{tabular}
...
({\tt +v db}), a confusion matrix ({\tt +v cm}), the nearest neighbors
on which decision are based ({\tt +v n}), just the class distributions
per $k$-nearest distance per classified instance ({\tt +v k}), or the
distances to the nearest neighbor ({\tt +v di}). E.g. the following
...
\cite{Daelemans+94}; grapheme-to-phoneme conversion,
...
\begin{verbatim}
TiMBL 5.3 (release) (c) ILK 1998 - 2003.
Tilburg Memory Based Learner
Induction of Linguistic Knowledge Research Group
Tilburg University / University of Antwerp
Mon Nov  4 16:38:00 2003
...
sets with few features), {\tt n} can be increased up to 100,000.
