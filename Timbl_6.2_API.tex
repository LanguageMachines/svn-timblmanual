...
As you can readily gather from these examples, the basic thing you need to do to get access to the
...
{\tt matchDepth()}, {\tt matchedAtLeaf()}, {\tt WriteMatrices()}, {\tt GetMatrices()} and {\tt ShowStatistics()}. These reflect the additional functionality of Timbl 6.2.
The API is still experimental, and contains more functions than described in this manual. Using these 'undocumented' features is, as usual, unwise.
