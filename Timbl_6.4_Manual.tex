...
\vspace*{1cm} {\it ILK Technical Report -- ILK XX-XX}}
...
The current release (version 6.4) succeeds release 6.3. The most
...
At the {\bf syntactic} sentence level TiMBL has been applied to part of
...
\cite{Orasan00,Sang01}; detecting the scope of negation markers and
hedge cues \cite{Morante+08c,Morante+09c}; sentence-boundary detection
\cite{Stevenson+00}; and, beyond the sentence level,
to anaphora resolution \cite{Preiss02,Mitkov+02,Hoste05}. More
recently, memory-based learning has been integrated as a classifier
engine in more complicated dependency parsing systems
